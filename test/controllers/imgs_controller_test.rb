...
class ImgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create img" do
    assert_difference('Img.count') do
      post imgs_url, params: { img: { image_name: @img.image_name, real_name: @img.real_name } }
    end
  ...
  test "should update img" do
    patch img_url(@img), params: { img: { image_name: @img.image_name, real_name: @img.real_name } }
